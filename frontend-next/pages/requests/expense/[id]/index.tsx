/**
 * Expense Request Detail Page - تفاصيل طلب المصروف
 * ======================================================
 * View and manage expense request details
 */
...
export default function ExpenseRequestDetailPage() {
    ...
    const fetchRequest = async () => {
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(errorData.error || 'Failed to fetch expense request');
        }
  ...
  return (
    <MainLayout>
      <Head>
        <title>{request.request_number} - {isArabic ? 'طلب مصروف' : 'Expense Request'} - SLMS</title>
      </Head>
      ...
      <div className="p-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {isArabic ? 'طلب مصروف' : 'Expense Request'}
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="text-3xl font-bold text-green-600 dark:text-green-400">
                {formatAmount(request.total_amount)} {request.currency_code}
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            {/* Source Info */}
            {request.source_type === 'shipment_expense' && (
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800 p-4">
                <h3 className="text-sm font-medium text-purple-800 dark:text-purple-300 mb-2">
                  {isArabic ? 'مزامن تلقائياً' : 'Auto-Synced'}
                </h3>
                <p className="text-xs text-purple-600 dark:text-purple-400">
                  {isArabic 
                    ? 'هذا الطلب تم إنشاؤه تلقائياً من مصاريف الشحنات'
                    : 'This request was auto-created from shipment expenses'}
                </p>
              </div>
            )}
