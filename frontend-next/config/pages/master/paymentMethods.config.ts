/**
 * Payment Methods Master Data — Page Configuration
 * Auto-generated governance config for Payment Methods CRUD.
 */
...
const formSections: PageSection[] = [
  {
    ...
    label: 'Identity',
    fields: [
      { key: 'code',        label: 'Code',           type: 'code',     required: 'optional',    placeholder: 'Payment method code', autoUppercase: true, colSpan: 4 },
      { key: 'name_en',     label: 'Name (English)',  type: 'text',     required: 'required',    placeholder: 'Payment method name in English' },
      { key: 'name_ar',     label: 'Name (Arabic)',   type: 'text',     required: 'recommended', placeholder: 'اسم طريقة الدفع بالعربية' },
      { key: 'description', label: 'Description',     type: 'textarea', required: 'optional',    placeholder: 'Brief description of this payment method', colSpan: 'full' as any },
    ],
  },
  {
    key: 'settings',
...
export const paymentMethodsConfig: PageConfig<PaymentMethod> = {
  ...
  subtitle: 'Manage payment method definitions (cash, bank transfer, cheque, etc.)',
  breadcrumbs: [
    { label: 'Home', href: '/' },
