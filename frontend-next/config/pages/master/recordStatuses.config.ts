 ...
 * Auto-generated governance config for Record Statuses CRUD.
 */
...
const formSections: PageSection[] = [
  {
    ...
    fields: [
      ...
      { key: 'name_ar', label: 'Name (Arabic)',   type: 'text', required: 'recommended', placeholder: 'اسم حالة السجل بالعربية' },
    ],
  },
  {
    key: 'appearance',
...
const actions: ActionMeta[] = [
  { key: 'create', label: 'Create New',  icon: 'PlusIcon',           variant: 'primary',   permission: 'master:record_statuses:create', position: ['toolbar'] },
  { key: 'edit',   label: 'Edit',        icon: 'PencilSquareIcon',   variant: 'secondary', permission: 'master:record_statuses:edit',   position: ['row'] },
  { key: 'delete', label: 'Delete',      icon: 'TrashIcon',          variant: 'danger',    permission: 'master:record_statuses:delete', position: ['row', 'bulk'], requireConfirmation: true, isDangerous: true },
...
export const recordStatusesConfig: PageConfig<RecordStatus> = {
  ...
  subtitle: 'Manage general record status definitions and lifecycle stages',
  breadcrumbs: [
    { label: 'Home', href: '/' },
